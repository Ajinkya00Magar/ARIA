    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold">IBM Coding Agent</h1>
        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-lg">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-9 pr-9 py-2 bg-background border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                />
                <button
                  type="button"
          ...
          <div className="grid grid-cols-2 gap-3">
            <a
              ...
              className="flex items-center justify-center gap-2 py-2 px-4 border border-input rounded-lg text-sm hover:bg-accent transition-colors"
            >
